...
const BpAddressIndependentEmailApi_1 = require("./BpAddressIndependentEmailApi");
const BpAddressIndependentFaxApi_1 = require("./BpAddressIndependentFaxApi");
const BpAddressIndependentMobileApi_1 = require("./BpAddressIndependentMobileApi");
const BpAddressIndependentPhoneApi_1 = require("./BpAddressIndependentPhoneApi");
const BpAddressIndependentWebsiteApi_1 = require("./BpAddressIndependentWebsiteApi");
...
const BpEmploymentApi_1 = require("./BpEmploymentApi");
...
const BusinessPartnerAliasApi_1 = require("./BusinessPartnerAliasApi");
...
const BusinessPartnerIsBankApi_1 = require("./BusinessPartnerIsBankApi");
...
class ApiBusinessPartner {
    ...
    get bpAddressIndependentEmailApi() {
        return this.initApi('bpAddressIndependentEmailApi', BpAddressIndependentEmailApi_1.BpAddressIndependentEmailApi);
    }
    get bpAddressIndependentFaxApi() {
        return this.initApi('bpAddressIndependentFaxApi', BpAddressIndependentFaxApi_1.BpAddressIndependentFaxApi);
    }
    get bpAddressIndependentMobileApi() {
        return this.initApi('bpAddressIndependentMobileApi', BpAddressIndependentMobileApi_1.BpAddressIndependentMobileApi);
    }
    get bpAddressIndependentPhoneApi() {
        return this.initApi('bpAddressIndependentPhoneApi', BpAddressIndependentPhoneApi_1.BpAddressIndependentPhoneApi);
    }
    get bpAddressIndependentWebsiteApi() {
        return this.initApi('bpAddressIndependentWebsiteApi', BpAddressIndependentWebsiteApi_1.BpAddressIndependentWebsiteApi);
    }
    ...
    get bpEmploymentApi() {
        return this.initApi('bpEmploymentApi', BpEmploymentApi_1.BpEmploymentApi);
    }
    ...
    get businessPartnerApi() {
        ...
        const linkedApis = [
            this.initApi('bpAddressIndependentEmailApi', BpAddressIndependentEmailApi_1.BpAddressIndependentEmailApi),
            this.initApi('bpAddressIndependentFaxApi', BpAddressIndependentFaxApi_1.BpAddressIndependentFaxApi),
            this.initApi('bpAddressIndependentMobileApi', BpAddressIndependentMobileApi_1.BpAddressIndependentMobileApi),
            this.initApi('bpAddressIndependentPhoneApi', BpAddressIndependentPhoneApi_1.BpAddressIndependentPhoneApi),
            this.initApi('bpAddressIndependentWebsiteApi', BpAddressIndependentWebsiteApi_1.BpAddressIndependentWebsiteApi),
            ...
            this.initApi('bpEmploymentApi', BpEmploymentApi_1.BpEmploymentApi),
            ...
            this.initApi('businessPartnerAliasApi', BusinessPartnerAliasApi_1.BusinessPartnerAliasApi),
            ...
            this.initApi('businessPartnerIsBankApi', BusinessPartnerIsBankApi_1.BusinessPartnerIsBankApi),
    ...
    get businessPartnerAliasApi() {
        return this.initApi('businessPartnerAliasApi', BusinessPartnerAliasApi_1.BusinessPartnerAliasApi);
    }
    ...
    get businessPartnerIsBankApi() {
        return this.initApi('businessPartnerIsBankApi', BusinessPartnerIsBankApi_1.BusinessPartnerIsBankApi);
    }
